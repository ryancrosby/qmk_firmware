...
#define _________________QWERTY_L2_________________        MO(_SYMBOLS),   KC_A,    CTL_T(KC_S),    ALT_T(KC_D),    CMD_T(KC_F),    KC_G
...
#define _________________QWERTY_R2_________________        KC_H,    RCMD_T(KC_J),    RALT_T(KC_K),    RCTL_T(KC_L),    KC_SCLN, MO(_SYMBOLS)
...
// NAVIGATION LAYER
#define ________________NAV_L1________________        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
#define ________________NAV_L2________________        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
#define ________________NAV_L3________________        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
...
// Planck
#define ________________PLANCK_L4________________        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_ENT
#define ________________PLANCK_R4________________        KC_SPC,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
